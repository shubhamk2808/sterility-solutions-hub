...
export default function BiologicalIndicators() {
  return (
    <Layout>
      <PageHero
        badge="Biological Indicators"
        title={<>Biological <span className="text-gradient">Indicators</span></>}
        description="Spore-based biological indicators providing the most accurate measurement of sterilization process lethality per ISO 11138 standards."
      >
