    ...
    <Layout>
      ...
      <section className="relative py-20 md:py-28 overflow-hidden">
        <div className="absolute inset-0">
          <img src={gammaImage} alt="Gamma Irradiation Facility" className="w-full h-full object-cover" />
            ...
            >
              ...
              <div className="flex items-center gap-3 mb-6">
                <div className="w-14 h-14 bg-background/20 backdrop-blur rounded-xl flex items-center justify-center">
                  <Radiation className="w-7 h-7 text-background" />
                </div>
              ...
              <h1 className="text-4xl md:text-5xl font-bold text-background mb-6">
                Gamma{" "}
                <span className="text-secondary">Irradiation</span>
              </h1>
